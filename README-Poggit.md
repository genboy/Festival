...
- create and manage area's (like WorldGuard/iProtector)
  ...
  - set the area flags to true to
    ...
    - passage: only ops and whitelisted players can enter or leave the area! (v1.0.3-11 changed barrier to passage)
- manage area events
...
#### Milestones 
  ...
  - [x] Barrier flag; turning the area into a barrier, no one in, no one out. (this is now 'Passage' or pass for short)
...
GLGPL content enclosed in package LICENSE file